...
define config.version = "1.1 试玩版"


## 放置在游戏内“关于”屏幕上的文本。将文本放在三个引号之间，并在段落之间留出空
## 行。

define gui.about = _p("""谨以此作品
记录乱世中仍然试图活得像人的无名者。

本作属于历史幻想题材，年代、地点与人物均经过艺术加工。

音频素材来自 OpenGameArt，采用 CC0 许可；完整来源见 docs/assets-license.md。
""")
...
## 2026-09-11：使用许可明确的 CC0 环境音乐作为标题氛围。
define config.main_menu_music = audio_dark_ambient
...
define config.save_directory = "51-1781056427"

...
define gui.accent_color = '#c9aa71'
...
## 用。
define gui.muted_color = '#493b2c'
define gui.hover_muted_color = '#725d43'
...
## 兼容性增强：仅为项目字体缺失的罕见汉字提供系统字体回退，保持主体字体外观不变。
init python:
    if renpy.windows:
        chinese_font = FontGroup().add("0@C:/Windows/Fonts/msyh.ttc", "邙", "邙").add("SourceHanSansLite.ttf", None, None)
